  ...
  return (
    <View className="gap-3 mb-6">
      <View className="flex-row gap-3">
        {/* Residents Stat */}
        <Card className="flex-1 py-4 items-center" accessibilityLabel={`Residents: ${residentsCount}`}>
          <View className="bg-blue-500/10 p-2 rounded-full mb-1">
            <Ionicons name="people-outline" size={20} color="#3b82f6" />
          </View>
          <Text className="text-foreground-light dark:text-foreground-dark font-bold text-xl font-mono">
        ...
        {/* Tickets Stat */}
        <Card className="flex-1 py-4 items-center" accessibilityLabel={`Open Tickets: ${openComplaintsCount}`}>
      ...
      <View className="flex-row gap-3">
        {/* Visitors Stat */}
        <Card className="flex-1 py-4 items-center" accessibilityLabel={`Active Inside: ${activeVisitorsCount}`}>
        ...
        {/* Dues Stat */}
        <Card className="flex-1 py-4 items-center" accessibilityLabel={`Unpaid Dues: ₹${pendingDuesSum.toLocaleString()}`}>
          <View className="bg-emerald-500/10 p-2 rounded-full mb-1">
            <Ionicons name="wallet-outline" size={20} color="#10b981" />
          </View>
          <Text className="text-foreground-light dark:text-foreground-dark font-bold text-base font-mono">
